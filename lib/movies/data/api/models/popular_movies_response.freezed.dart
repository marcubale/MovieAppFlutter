...
/// @nodoc
@JsonSerializable()
class _$_PopularMoviesResponse extends _PopularMoviesResponse {
  ...
  @override
  String toString() {
    return 'PopularMoviesResponse(page: $page, totalPages: $totalPages, totalResults: $totalResults, results: $results)';
  }
...
class _$_MovieResponse extends _MovieResponse {
  ...
  @override
  String toString() {
    return 'MovieResponse(id: $id, title: $title, overview: $overview, posterPath: $posterPath, releaseDate: $releaseDate)';
  }
